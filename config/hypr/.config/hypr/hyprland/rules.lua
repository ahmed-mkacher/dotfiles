...
-- Foot: keep compositor at full opacity so blur fills the terminal's transparent areas
...
hl.window_rule({ match = { class = "helium|Helium|zen|Zen" }, workspace = "special:special" })
hl.window_rule({
	match = {
...
hl.window_rule({
	match = {
		class = "discord|equibop|Telegram|TelegramDesktop|telegram-desktop|org.telegram.desktop|vesktop|whatsapp",
	},
