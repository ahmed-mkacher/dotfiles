...
hl.bind("SUPER + B", hl.dsp.exec_cmd("qs -c caelestia ipc call drawers toggle bar"))
...
-- Move window to direction with vim motions
...
hl.bind("SUPER + SHIFT + A", hl.dsp.window.move({ workspace = "special:music" }))
hl.bind("SUPER + SHIFT + D", hl.dsp.window.move({ workspace = "special:communication" }))
hl.bind("SUPER + SHIFT + R", hl.dsp.window.move({ workspace = "special:todo" }))
hl.bind("SUPER + SHIFT + E", hl.dsp.window.move({ workspace = "special:sysmon" }))
...
hl.bind("SUPER + CTRL + S", hl.dsp.exec_cmd("$HOME/.local/bin/caelestia-screenshot"))
...
-- Sleep
hl.bind("SUPER + SHIFT + Z", hl.dsp.exec_cmd(vars.sleepGestureCmd), { locked = true })
